...
public class BinaryTree<E> implements Serializable {
	...
	/**
	 * Constructs binary tree with given data as the root and the two given
	 * subtrees
	 * 
	 * @param data
	 ...
	 *
	 * @return Returns the trees left subtree. returns null if left subtree is
	 *         empty
	 */
	 ...
	 *
	 * @return Returns the trees right subtree. returns null if right subtree is
	 *         empty
	 */
	 ...
	 *
	 * @return Returns the root nodes data. returns null if node is null
	 */
	public E getData() {
		if (root != null) {
			return root.data;
	 ...
	 * 
	 * @return returns true if node is a leaf node. otherwise, returns false
	 */
	 ...
	 * 
	 * @return returns preorder traversal string representation of binary tree
	 */
	 ...
	 * 
	 * @param sb
	 *            string being appended to be returned as string representation
	 *            of tree
	 * 
	 ...
	 * @return Binary tree created from scanner
	 */
	...
	protected static class Node<E> implements Serializable {
		...
		/**
		 * provides String representation of data in node. assumes node is not
		 * null
		 * 
		 * @return returns string representation of data in node
		 */
		public String toString() {
