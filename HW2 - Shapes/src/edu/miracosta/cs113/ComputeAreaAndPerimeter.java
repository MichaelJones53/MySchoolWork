...
/**
Computes the area and perimeter of selected figures. @author Koffman and Wolfgang
*/
...
2. It asks the user for the characteristics of that figure. 3. It computes the perimeter.
...
/** Ask the user for the type of figure. @return An instance of the selected shape
*/
